		...
		do {
	  	var thisRow = jQuery("<tr></tr>");
			...
			for (var i=0; i<7; i++) {
				...
				//DateBox Events, fix code chao.gao
				var dateLink = jQuery('<div class="DateLabel"><a href="'+ defaults.baseUrl + encodeURIComponent(_currentDate.toDateString()) + '">' + _currentDate.getDate() + '</a></div>').click(function(e) {
